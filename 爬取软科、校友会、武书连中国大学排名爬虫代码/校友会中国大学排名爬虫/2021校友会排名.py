...
url = 'http://www.chinaxy.com/2022index/news/news.jsp?information_id=52'
...
target_tables = all_tables[10:12]
...
# 将排名信息保存为CSV文件
with open('../data1/2021校友会中国大学排名.csv', 'w', newline='', encoding='utf-8') as csvfile:
    fieldnames = ['排名', '排名1', '学校', '总分', '星级', '办学层次']
    writer = csv.DictWriter(csvfile, fieldnames=fieldnames)

    writer.writeheader()  # 写入表头
    for ranking in top_200_rankings:  # 遍历前200条记录
